...
@Component({
  selector: 'app-gat-onnet-offnet-operator-detail',
  templateUrl: './gat-onnet-offnet-operator-detail.component.html',
  styleUrls: ['./gat-onnet-offnet-operator-detail.component.scss']
})
export class GatOnnetOffnetOperatorDetailComponent implements OnInit {
