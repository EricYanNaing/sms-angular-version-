...
@Component({
  selector: 'app-sugar-mill-factory-onnet-offnet-operator-detail',
  templateUrl: './sugar-mill-factory-onnet-offnet-operator-detail.component.html',
  styleUrls: ['./sugar-mill-factory-onnet-offnet-operator-detail.component.scss']
})
export class SugarMillFactoryOnnetOffnetOperatorDetailComponent implements OnInit {
