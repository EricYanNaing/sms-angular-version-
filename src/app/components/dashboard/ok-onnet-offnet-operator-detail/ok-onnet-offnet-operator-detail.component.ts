...
@Component({
  selector: 'app-ok-onnet-offnet-operator-detail',
  templateUrl: './ok-onnet-offnet-operator-detail.component.html',
  styleUrls: ['./ok-onnet-offnet-operator-detail.component.scss']
})
export class OkOnnetOffnetOperatorDetailComponent implements OnInit {
