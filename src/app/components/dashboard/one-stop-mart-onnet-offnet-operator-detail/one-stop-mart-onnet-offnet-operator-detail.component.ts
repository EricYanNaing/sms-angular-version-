...
@Component({
  selector: 'app-one-stop-mart-onnet-offnet-operator-detail',
  templateUrl: './one-stop-mart-onnet-offnet-operator-detail.component.html',
  styleUrls: ['./one-stop-mart-onnet-offnet-operator-detail.component.scss']
})
export class OneStopMartOnnetOffnetOperatorDetailComponent implements OnInit {
