...
@Component({
  selector: 'app-ok-taxi-onnet-offnet-operator-detail',
  templateUrl: './ok-taxi-onnet-offnet-operator-detail.component.html',
  styleUrls: ['./ok-taxi-onnet-offnet-operator-detail.component.scss']
})
export class OkTaxiOnnetOffnetOperatorDetailComponent implements OnInit {
