...
@Component({
  selector: 'app-cgm-onnet-offnet-operator-detail',
  templateUrl: './cgm-onnet-offnet-operator-detail.component.html',
  styleUrls: ['./cgm-onnet-offnet-operator-detail.component.scss']
})
export class CgmOnnetOffnetOperatorDetailComponent implements OnInit {
